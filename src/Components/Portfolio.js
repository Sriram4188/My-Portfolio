    ...
    <div className='mt-5 flex justify-center flex-col'>
        ...
        <div className='flex flex-row justify-evenly gap-2 px-4 md:px-72'>
            ...
            focus:ring-violet-300 focus:bg-purple-600 focus:ring '>All</button>
             <button  onClick={()=>filterPortfolio('ML')}  className='border-purple-600 border-2 
            text-purple-600 focus:text-white
            active:bg-purple-500 p-1 px-4 rounded-md
            focus:ring-violet-300 focus:bg-purple-600 focus:ring '>ML</button>
             <button onClick={()=>filterPortfolio('FullStack')} className='border-purple-600 border-2 
            text-purple-600 focus:text-white
            active:bg-purple-500 p-1 px-4 rounded-md
            focus:ring-violet-300 focus:bg-purple-600 focus:ring '>FullStack</button>
             <button onClick={()=>filterPortfolio('Mobile App')} className='border-purple-600 border-2 
            text-purple-600 focus:text-white
            active:bg-purple-500 p-1 px-4 rounded-md
